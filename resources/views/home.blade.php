...
<section class="relative min-h-screen flex items-center overflow-hidden" style="background-color:#f0f7ff;">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 pt-36 pb-24 w-full">
        ...
        {{-- ═══ ONGOING PROJECTS LIVE TICKER (FULL WIDTH & RIGHT TO LEFT MARQUEE) ═══ --}}
        @php
        ...
        <div class="mb-10 w-full animate-fadeInUp" style="animation-delay:0.05s">
            <div class="flex items-center rounded-2xl bg-white/95 backdrop-blur-md border border-blue-200/80 shadow-lg p-2 overflow-hidden group w-full">
                {{-- Ticker Badge --}}
                <div class="px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-extrabold text-xs uppercase tracking-wider flex items-center gap-2 flex-shrink-0 z-20 shadow-sm">
                    ...
                    <div class="marquee-track flex items-center gap-8 whitespace-nowrap group-hover:[animation-play-state:paused] py-1">
                        ...
                        @foreach([1, 2] as $loopPass)
                            ...
                            <div class="inline-flex items-center gap-2.5 text-xs text-slate-700 font-semibold flex-shrink-0">
                                ...
                                <span class="text-[10px] font-extrabold uppercase tracking-widest text-emerald-700 bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 rounded-full ml-1">
                                    {{ $proj->status }}
                                </span>
                            </div>
...
<section class="py-24 relative overflow-hidden bg-[#0b172c] text-white border-t border-b border-blue-900/60">
    ...
    <div class="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div class="bg-slate-900/60 rounded-3xl p-8 sm:p-12 border border-blue-500/20 shadow-2xl backdrop-blur-xl space-y-6 text-slate-300 text-sm sm:text-base leading-relaxed mb-10">
            ...
            <div class="grid md:grid-cols-2 gap-6 pt-2 border-t border-slate-800/80">
                <div class="space-y-4">
                    <p>
            ...
            <div class="pt-4 border-t border-slate-800/80 text-center">
                <p class="text-blue-200 text-sm sm:text-base font-semibold leading-relaxed">
        ...
        {{-- 3-Column Feature Bullet Grid --}}
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3.5 mb-10">
            @php
            $points = [
            ...
            <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-900/80 border border-blue-900/50 text-xs sm:text-sm text-slate-200 shadow-sm">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <a href="{{ route('contact') }}" class="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-sm shadow-xl shadow-blue-600/30 border border-blue-400/30 transition-all transform hover:-translate-y-0.5 inline-flex items-center gap-2">
...
<section class="py-20 relative overflow-hidden bg-slate-50 border-t border-slate-200">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6">
        <div class="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/90 shadow-xl text-center relative overflow-hidden group">
            {{-- Top Accent Glow Line --}}
            <div class="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-blue-600 via-sky-400 to-indigo-600"></div>

            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200/80 text-blue-700 text-xs font-extrabold uppercase tracking-widest mb-4 shadow-xs">
                <span>👥</span> Our Experts
            </div>
            
            <h2 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">Meet Our Team</h2>
            
            <p class="text-slate-500 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-8">
                The experienced architectural technologists, CAD specialists, and BIM visualisers powering BuildCares.
            </p>

            <div class="flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('team.index') }}" class="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-sm shadow-lg shadow-blue-600/30 border border-blue-400/30 transition-all transform hover:-translate-y-0.5 inline-flex items-center gap-2">
