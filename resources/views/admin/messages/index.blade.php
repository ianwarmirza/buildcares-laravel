...
<form id="bulk-form" action="{{ route('admin.messages.bulkDestroy') }}" method="POST">
    @csrf
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <button type="submit" id="delete-selected-btn" disabled
            ...
            <tbody class="divide-y divide-slate-200">
                ...
                <tr class="hover:bg-light-warm transition-colors {{ !$msg->is_read ? 'bg-gold/5' : '' }}">
                    <td class="py-3 px-4 text-center">
                        <input type="checkbox" name="ids[]" value="{{ $msg->id }}" class="msg-checkbox w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500 cursor-pointer">
                    </td>
                    <td class="py-3 px-4">
                        <div class="flex items-center gap-3">
                            @if(!$msg->is_read)
